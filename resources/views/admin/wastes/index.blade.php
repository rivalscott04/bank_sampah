...
@section('content')
                            ...
                            @forelse ($wastes as $index => $waste)
                                <tr class="hover:bg-slate-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                        {{ $waste->created_at->format('d M Y') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('admin.wastes.edit', $waste->id) }}"
                                            ...
                                            <button onclick="confirmDelete({{ $waste->id }})"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 max-w-md w-mx-4">
            ...
            <p class="text-sm text-slate-500 mb-6">
                Apakah Anda yakin ingin menghapus data sampah ini? Tindakan ini tidak dapat dibatalkan.
            </p>
    ...
    <script>
        function confirmDelete(wasteId) {
            ...
            form.action = `/admin/wastes/${wasteId}`;
