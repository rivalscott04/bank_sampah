...
@section('content')
    <!-- Hero Section -->
    <section
        class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50">
        <!-- Animated Background Elements -->
        <div class="absolute inset-0 overflow-hidden z-0">
            <div
                class="floating-shape absolute top-20 left-20 w-32 h-32 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full opacity-10 animate-float">
            </div>
            <div
                class="floating-shape absolute top-40 right-32 w-24 h-24 bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-full opacity-15 animate-float-delayed">
            </div>
            <div
                class="floating-shape absolute bottom-32 left-1/3 w-40 h-40 bg-gradient-to-r from-cyan-400 to-teal-500 rounded-full opacity-8 animate-float-slow">
            </div>
            <div
                class="floating-shape absolute bottom-20 right-20 w-28 h-28 bg-gradient-to-r from-teal-500 to-emerald-600 rounded-full opacity-12 animate-float-reverse">
            </div>
        </div>
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="animate-fade-in-up py-20">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-8">
                    <span
                        class="block bg-gradient-to-r from-teal-600 via-emerald-600 to-cyan-600 bg-clip-text text-transparent mb-4">Bank
                        Sampah</span>
                    <span class="block text-slate-700 text-2xl sm:text-3xl lg:text-4xl font-semibold">Digital
                        Platform</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    @guest
                        <a href="{{ route('register') }}" class="btn-primary group flex items-center">
                    ...
                    @else
                        @if (auth()->user()->role === 'admin')
                            <a href="{{ route('admin.dashboard') }}" class="btn-primary group flex items-center">
                        ...
                        @else
                            <a href="{{ route('nasabah.dashboard') }}" class="btn-primary group flex items-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mt-8">
                    <div class="glass-card group hover:scale-105 transition-all duration-300" data-aos="fade-up"
                        data-aos-delay="100">
                        <div class="text-3xl font-bold bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent mb-2"
                            data-counter="1000">0</div>
                        <div class="text-slate-600 text-sm font-medium">Nasabah Aktif</div>
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-teal-500/10 to-emerald-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </div>
                    </div>
                    <div class="glass-card group hover:scale-105 transition-all duration-300" data-aos="fade-up"
                        data-aos-delay="200">
                        <div class="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent mb-2"
                            data-counter="50">0</div>
                        <div class="text-slate-600 text-sm font-medium">Ton Sampah</div>
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </div>
                    </div>
                    <div class="glass-card group hover:scale-105 transition-all duration-300" data-aos="fade-up"
                        data-aos-delay="300">
                        <div class="text-3xl font-bold bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent mb-2"
                            data-counter="25">0</div>
                        <div class="text-slate-600 text-sm font-medium">Kota Terlayani</div>
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-teal-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </div>
                    </div>
                    <div class="glass-card group hover:scale-105 transition-all duration-300" data-aos="fade-up"
                        data-aos-delay="400">
    ...
    <!-- Features Section -->
    <section id="features"
        class="py-20 bg-gradient-to-br from-white via-teal-50/30 to-emerald-50/30 relative overflow-hidden">
        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-5">
            <div class="absolute top-0 left-0 w-full h-full"
                style="background-image: radial-gradient(circle at 25% 25%, #14b8a6 2px, transparent 2px), radial-gradient(circle at 75% 75%, #10b981 2px, transparent 2px); background-size: 50px 50px;">
            </div>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative z-10 text-center mb-16" data-aos="fade-up">
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
                    Fitur <span
                        class="bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">Unggulan</span>
                </h2>
            ...
            <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-icon-modern">
                        <svg class="w-12 h-12" fill="none" stroke="url(#gradient-teal-emerald)" viewBox="0 0 24 24">
                            <defs>
                                <linearGradient id="gradient-teal-emerald" x1="0%" y1="0%" x2="100%"
                                    y2="100%">
                    ...
                    <p class="text-slate-600 leading-relaxed">Sistem pembayaran digital yang aman dan transparan untuk
                        setiap transaksi sampah</p>
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-slate-600 leading-relaxed">Dashboard analitik yang memberikan insight mendalam tentang
                        aktivitas bank sampah</p>
                    <div class="feature-glow"></div>
                </div>
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="300">
                    <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="200">
                        <div class="feature-icon-modern">
                            <svg class="w-12 h-12" fill="none" stroke="url(#gradient-teal-emerald)"
                                viewBox="0 0 24 24">
                                <defs>
                                    <linearGradient id="gradient-teal-emerald" x1="0%" y1="0%"
                                        x2="100%" y2="100%">
                                        <stop offset="0%" style="stop-color:#14b8a6;stop-opacity:1" />
                                        <stop offset="100%" style="stop-color:#059669;stop-opacity:1" />
                                    </linearGradient>
                        ...
                        <p class="text-slate-600 leading-relaxed">Kelola data nasabah dengan mudah dan efisien melalui
                            sistem
                            terintegrasi</p>
                        <div class="feature-glow"></div>
                    </div>
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p class="text-slate-600 leading-relaxed">Dapatkan notifikasi real-time untuk setiap aktivitas dan
                        update penting</p>
                    <div class="feature-glow"></div>
                </div>
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <p class="text-slate-600 leading-relaxed">Sistem keamanan berlapis untuk melindungi data dan
                        transaksi
                        Anda</p>
                    <div class="feature-glow"></div>
                </div>
                ...
                <div class="modern-feature-card group" data-aos="fade-up" data-aos-delay="600">
                    <div class="feature-icon-modern">
                        <svg class="w-12 h-12" fill="none" stroke="url(#gradient-teal-emerald)" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 9 0 11-18 0 9 9 0 0118 0z">
                            </path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-slate-900 mb-3">Ramah Lingkungan</h3>
                    <p class="text-slate-600 leading-relaxed">Berkontribusi dalam menjaga lingkungan dengan sistem daur
                        ulang yang efektif</p>
                    <div class="feature-glow"></div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10">
            ...
            <div
                class="absolute bottom-20 right-20 w-16 h-16 bg-emerald-400 rounded-full animate-pulse animation-delay-1000">
            </div>
            <div class="absolute top-1/2 left-1/4 w-12 h-12 bg-cyan-400 rounded-full animate-pulse animation-delay-2000">
            </div>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative z-10 text-center mb-16" data-aos="fade-up">
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
                    Jenis <span
                        class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Sampah</span>
                </h2>
                <p class="text-lg text-slate-600 max-w-3xl mx-auto">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="step-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Buat akun gratis dan lengkapi profil Anda untuk
                        memulai</p>
                </div>
                ...
                <div class="step-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Pisahkan dan kumpulkan sampah sesuai dengan jenisnya
                    </p>
                </div>
                ...
                <div class="step-card" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Bawa sampah ke bank sampah terdekat atau jadwalkan
                        pickup</p>
                </div>
