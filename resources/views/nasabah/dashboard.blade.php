    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8 relative z-10">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl text-slate-600">Selamat datang kembali, <span
                                class="font-bold text-green-600">{{ auth()->user()->name }}</span>!</p>
                        <p class="text-sm text-slate-500 mt-2">Mari kelola sampah Anda dengan bijak dan dapatkan reward
                            menarik</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <!-- Total Transaksi -->
                <div
                    class="glass-effect backdrop-blur-lg bg-white/80 overflow-hidden shadow-2xl rounded-3xl transform hover:scale-105 transition-all duration-300 border border-white/20 animate-fade-in-up animation-delay-200">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-base font-semibold text-slate-600 truncate mb-1">Total Transaksi
                                    </dt>
                                    <dd class="text-3xl font-bold text-slate-900 counter"
                                        data-target="{{ $totalTransactions }}">0</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Permintaan Pending -->
                <div
                    class="glass-effect backdrop-blur-lg bg-white/80 overflow-hidden shadow-2xl rounded-3xl transform hover:scale-105 transition-all duration-300 border border-white/20 animate-fade-in-up animation-delay-400">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-base font-semibold text-slate-600 truncate mb-1">Permintaan Pending
                                    </dt>
                                    <dd class="text-3xl font-bold text-slate-900 counter"
                                        data-target="{{ $pendingPickups }}">0</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <a href="{{ route('nasabah.wastes.index') }}"
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 bg-green-100 p-4 rounded-2xl group-hover:bg-green-200 transition-colors duration-300 shadow-lg">
                                <svg class="h-8 w-8 text-green-600 group-hover:text-green-700 transition-colors duration-300"
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt
                                        class="text-lg font-bold text-slate-900 truncate mb-1 group-hover:text-green-600 transition-colors duration-300">
                                        Daftar Sampah</dt>
                                    <dd
                                        class="text-sm text-slate-600 group-hover:text-slate-700 transition-colors duration-300">
                                        Lihat daftar sampah yang tersedia</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('nasabah.pickup-requests.create') }}"
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 bg-blue-100 p-4 rounded-2xl group-hover:bg-blue-200 transition-colors duration-300 shadow-lg">
                                <svg class="h-8 w-8 text-blue-600 group-hover:text-blue-700 transition-colors duration-300"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt
                                        class="text-lg font-bold text-slate-900 truncate mb-1 group-hover:text-blue-600 transition-colors duration-300">
                                        Request Jemput</dt>
                                    <dd
                                        class="text-sm text-slate-600 group-hover:text-slate-700 transition-colors duration-300">
                                        Minta penjemputan sampah</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Riwayat Transaksi -->
                <a href="{{ route('nasabah.transactions') }}"
                    class="group glass-effect backdrop-blur-lg bg-white/80 overflow-hidden shadow-2xl rounded-3xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 border border-white/20 animate-fade-in-up animation-delay-400">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 bg-purple-100 p-4 rounded-2xl group-hover:bg-purple-200 transition-colors duration-300 shadow-lg">
                                <svg class="h-8 w-8 text-purple-600 group-hover:text-purple-700 transition-colors duration-300"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt
                                        class="text-lg font-bold text-slate-900 truncate mb-1 group-hover:text-purple-600 transition-colors duration-300">
                                        Riwayat Transaksi</dt>
                                    <dd
                                        class="text-sm text-slate-600 group-hover:text-slate-700 transition-colors duration-300">
                                        Lihat transaksi Anda</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('nasabah.profile') }}"
                    class="group glass-effect backdrop-blur-lg bg-white/80 overflow-hidden shadow-2xl rounded-3xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 border border-white/20 animate-fade-in-up animation-delay-600">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 bg-indigo-100 p-4 rounded-2xl group-hover:bg-indigo-200 transition-colors duration-300 shadow-lg">
                                <svg class="h-8 w-8 text-indigo-600 group-hover:text-indigo-700 transition-colors duration-300"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt
                                        class="text-lg font-bold text-slate-900 truncate mb-1 group-hover:text-indigo-600 transition-colors duration-300">
                                        Update Profil</dt>
                                    <dd
                                        class="text-sm text-slate-600 group-hover:text-slate-700 transition-colors duration-300">
                                        Edit profil Anda</dd>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Recent Transactions -->
                <div
                    class="glass-effect backdrop-blur-lg bg-white/80 shadow-2xl rounded-3xl border border-white/20 animate-fade-in-up">
                    <div class="px-6 py-6 sm:p-8">
                        ...
                        @if ($recentTransactions->count() > 0)
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-bold text-slate-900">
                                                    {{ $transaction->waste->name }}</p>
                                                <p class="text-xs text-slate-500">{{ $transaction->weight }} kg •
                                        ...
                                        <div class="text-right">
                                            ...
                                            <p class="text-xs text-yellow-600 font-semibold">
                                                +{{ number_format($transaction->total_points) }} poin</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="mt-6">
                                <a href="{{ route('nasabah.transactions') }}"
                                    class="inline-flex items-center text-sm font-semibold text-green-600 hover:text-green-500 transition-colors duration-300">
                        ...
                        @if ($recentPickups->count() > 0)
                            <div class="space-y-4">
                                @foreach ($recentPickups as $pickup)
                                    <div
                                        class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-blue-100 hover:shadow-lg transition-all duration-300">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-bold text-slate-900">{{ $pickup->waste->name }}
                                                </p>
                                                <p class="text-xs text-slate-500">{{ $pickup->estimated_weight }} kg •
                                                    {{ $pickup->date_request->format('d M Y') }}</p>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            @if ($pickup->status === 'pending')
                                                <span
                                                    ...
                                                    <div class="w-2 h-2 bg-yellow-400 rounded-full mr-2 animate-pulse">
                                                    </div>
                                                    Pending
                                                </span>
